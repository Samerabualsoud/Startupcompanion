  ...
  return (
    <div className="min-h-screen flex" style={{ background: 'oklch(0.978 0.008 80)' }}>
      ...
      >
        ...
        <div>
          <blockquote className="text-2xl font-medium leading-relaxed mb-6" style={{ color: 'oklch(0.88 0.03 80)', fontFamily: 'Playfair Display, serif' }}>
            "The best time to value your startup is before you need to."
          </blockquote>
          <div className="space-y-4">
            {[
              { num: '10+', label: 'Startup tools in one place' },
              { num: '7', label: 'Valuation methods' },
              { num: '100+', label: 'Investors & accelerators' },
            ].map(item => (
        ...
        <div className="text-xs" style={{ color: 'oklch(0.4 0.03 240)' }}>
          © {new Date().getFullYear()} AI Startup Toolkit. All calculations are estimates only.
        </div>
      </div>
