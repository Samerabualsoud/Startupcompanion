        ...
        >
          ...
          <div className="flex justify-center mb-6">
            <div className="flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-semibold"
              style={{ background: 'oklch(0.18 0.05 240)', color: 'oklch(0.55 0.13 30)', border: '1px solid oklch(0.28 0.04 240)' }}>
          ...
          {/* Title */}
          <h1 className="text-4xl font-bold text-center text-foreground mb-3" style={{ fontFamily: 'Playfair Display, serif' }}>
          ...
          <div className="rounded-2xl overflow-hidden shadow-xl border border-border bg-card">
            {/* Card Header */}
            <div className="px-8 py-8 text-white" style={{ background: 'oklch(0.18 0.05 240)' }}>
              <div className="flex items-start justify-between">
                <div>
                  <div className="text-xs font-bold uppercase tracking-widest mb-2" style={{ color: 'oklch(0.55 0.13 30)' }}>
                    Pro Plan
                  </div>
                  <div className="flex items-end gap-2">
                    <span className="text-5xl font-bold" style={{ fontFamily: 'Playfair Display, serif' }}>$9.99</span>
                    <span className="text-lg mb-2" style={{ color: 'oklch(0.62 0.02 240)' }}>/month</span>
                  </div>
                  <p className="text-sm mt-2" style={{ color: 'oklch(0.62 0.02 240)' }}>
                    Cancel anytime. No long-term commitment.
                  </p>
                </div>
                <div className="flex items-center gap-1 px-3 py-1.5 rounded-full text-xs font-semibold"
                  style={{ background: 'oklch(0.55 0.13 30)', color: 'white' }}>
