...
// ─── Arabic Question Flow ──────────────────────────────────────────────────────

export const CHAT_QUESTIONS_AR: ChatQuestion[] = [
  {
    id: 'companyName',
    emoji: '👋',
    text: 'ما اسم شركتك الناشئة؟',
    subtext: 'الاسم فقط — سنستخدمه في تقريرك.',
    type: 'text',
    placeholder: 'مثال: أكمي للذكاء الاصطناعي',
    mapTo: 'companyName',
    defaultValue: 'شركتي الناشئة',
  },
  {
    id: 'sector',
    emoji: '🏭',
    text: 'ما الذي تفعله شركتك؟ اختر أقرب فئة.',
    subtext: 'يساعدنا هذا على استخدام المعايير الصناعية الصحيحة.',
    type: 'select',
    options: SECTOR_OPTIONS,
    mapTo: 'sector',
    defaultValue: 'saas',
  ...
  },
  {
    id: 'stage',
    emoji: '🚀',
    text: 'في أي مرحلة تقع شركتك؟',
    subtext: 'يؤثر هذا على طرق التقييم الأكثر أهمية.',
    type: 'select',
    options: [
      { value: 'pre-seed', label: 'ما قبل البذرة — فكرة أو نموذج أولي، لا إيرادات بعد' },
      { value: 'seed', label: 'البذرة — منتج مبكر، ربما بعض العملاء الأوائل' },
      { value: 'series-a', label: 'السلسلة أ — ملاءمة المنتج للسوق، إيرادات متنامية' },
      { value: 'series-b', label: 'السلسلة ب — توسع سريع، نموذج أعمال مثبت' },
      { value: 'growth', label: 'النمو — إيرادات كبيرة، توسع في أسواق جديدة' },
    ],
    mapTo: 'stage',
    defaultValue: 'seed',
    transform: (val: string) => ({
  ...
  },
  {
    id: 'currentARR',
    emoji: '💰',
    text: 'كم إيراد شركتك السنوي؟',
    subtext: 'إذا لم تبدأ بعد في تحقيق الإيرادات، أدخل 0. هذا هو الإيراد السنوي المتكرر (ARR).',
    type: 'currency',
    placeholder: '500000',
    min: 0,
    step: 10000,
  ...
  },
  {
    id: 'revenueGrowthRate',
    emoji: '📈',
    text: 'ما معدل نمو إيراداتك سنوياً؟',
    subtext: 'مثال: إذا انتقلت من 500 ألف إلى 1.1 مليون العام الماضي، فهذا نمو بنسبة 120٪.',
    type: 'percent',
    placeholder: '120',
    min: 0,
    max: 1000,
  ...
  },
  {
    id: 'grossMargin',
    emoji: '📊',
    text: 'ما نسبة الربح من إيراداتك قبل تكاليف التشغيل؟',
    subtext: 'هذا هو هامش الربح الإجمالي. شركات البرمجيات عادةً 60–85٪.',
    type: 'percent',
    placeholder: '70',
    min: 0,
    max: 100,
  ...
  },
  {
    id: 'burnRate',
    emoji: '🔥',
    text: 'كم تنفق شركتك شهرياً؟',
    subtext: 'هذا هو معدل الحرق الشهري — إجمالي المصروفات (رواتب، إيجار، برمجيات، تسويق...). إذا كنت رابحاً، أدخل 0.',
    type: 'currency',
    placeholder: '150000',
    min: 0,
    step: 5000,
  ...
  },
  {
    id: 'cashOnHand',
    emoji: '🏦',
    text: 'كم يوجد في حسابات شركتك الآن؟',
    subtext: 'اشمل جميع الأموال السائلة — حسابات بنكية، استثمارات قصيرة الأجل. يساعدنا هذا في حساب مدة البقاء.',
    type: 'currency',
    placeholder: '2000000',
    min: 0,
    step: 100000,
  ...
  },
  {
    id: 'totalAddressableMarket',
    emoji: '🌍',
    text: 'ما حجم السوق الكلي الذي تستهدفه؟',
    subtext: 'هذا هو إجمالي السوق المتاح (TAM) — الفرصة الإيرادية الكاملة إذا استحوذت على 100٪ من السوق.',
    type: 'currency',
    placeholder: '5000000000',
    min: 0,
    step: 100000000,
  ...
  },
  {
    id: 'projectedRevenue5Y',
    emoji: '🔭',
    text: 'ما الإيراد السنوي الذي تتوقعه بشكل واقعي خلال 5 سنوات؟',
    subtext: 'كن طموحاً لكن صادقاً. هذا هدفك الإيرادي لـ 5 سنوات.',
    type: 'currency',
    placeholder: '20000000',
    min: 0,
    step: 500000,
  ...
  },
  {
    id: 'teamScore',
    emoji: '👥',
    text: 'ما مدى قوة فريقك التأسيسي؟ (0–100)',
    subtext: 'فكر في: الخبرة في المجال، تجربة الشركات الناشئة السابقة، المهارات التقنية. 50 = مؤسس عادي. 80+ = رائد أعمال متسلسل.',
    type: 'slider',
    min: 0,
    max: 100,
    step: 5,
  ...
  },
  {
    id: 'marketScore',
    emoji: '📡',
    text: 'ما مدى جاذبية فرصتك في السوق؟ (0–100)',
    subtext: 'ضع في الاعتبار: حجم السوق، معدل النمو، التوقيت، وإلحاحية المشكلة. 50 = سوق متخصص جيد. 80+ = سوق كبير سريع النمو.',
    type: 'slider',
    min: 0,
    max: 100,
    step: 5,
  ...
  },
  {
    id: 'productScore',
    emoji: '🛠️',
    text: 'ما مدى تميز منتجك أو تقنيتك؟ (0–100)',
    subtext: 'فكر في: الميزات الفريدة، براءات الاختراع، الحصن التقني، أو البيانات الخاصة. 50 = منتج متين، بعض المنافسة. 80+ = صعب التقليد.',
    type: 'slider',
    min: 0,
    max: 100,
    step: 5,
  ...
  },
  {
    id: 'competitiveScore',
    emoji: '⚔️',
    text: 'ما مدى ملاءمة بيئتك التنافسية؟ (0–100)',
    subtext: 'درجة أعلى = منافسون أقل. 50 = تنافسية لكن لديك تميز. 80+ = سوق مفتوح أو موقع رائد واضح.',
    type: 'slider',
    min: 0,
    max: 100,
    step: 5,
  ...
  },
  {
    id: 'riskOverall',
    emoji: '🛡️',
    text: 'بشكل عام، ما مدى خطورة شركتك مقارنةً بشركة ناشئة نموذجية في مرحلتك؟',
    subtext: 'يشمل هذا المخاطر التنظيمية والتكنولوجية وسوق المخاطر.',
    type: 'select',
    options: [
      { value: 'very_low', label: '🟢 منخفضة جداً — نموذج مثبت، تنظيم منخفض، مسار واضح للإيرادات' },
      { value: 'low', label: '🟡 منخفضة — بعض عدم اليقين لكن سوق مفهوم جيداً' },
      { value: 'medium', label: '🟠 متوسطة — مخاطر شركة ناشئة نموذجية، بعض المجهول' },
      { value: 'high', label: '🔴 عالية — سوق جديد، عقبات تنظيمية، أو تقنية غير مثبتة' },
      { value: 'very_high', label: '🚨 عالية جداً — تقنية عميقة، تقنية حيوية، أو قطاع شديد التنظيم' },
    ],
    mapTo: 'riskOverall',
    defaultValue: 'medium',
    transform: (val: string) => {
  ...
  },
  {
    id: 'exitMultiple',
    emoji: '🎯',
    text: 'إذا تم الاستحواذ على شركتك أو طرحها للاكتتاب، ما مضاعف الخروج المتوقع؟',
    subtext: 'هذا هو عدد مرات إيراداتك السنوية التي قد يدفعها المستحوذ. شركات SaaS غالباً 5–15x. شركات الذكاء الاصطناعي عالية النمو قد تصل 20x+.',
    type: 'select',
    options: [
      { value: '4', label: '4x — محافظ، نمو أبطأ أو أعمال خدمات' },
      { value: '6', label: '6x — معتدل، SaaS أو سوق متين' },
      { value: '8', label: '8x — جيد، SaaS ذو نمو قوي' },
      { value: '12', label: '12x — قوي، شركة تقنية عالية النمو' },
      { value: '15', label: '15x — متميز، رائد السوق أو أصيل بالذكاء الاصطناعي' },
      { value: '20', label: '20x+ — استثنائي، شركة تحدد فئتها' },
    ],
    mapTo: 'exitMultiple',
    defaultValue: '8',
    transform: (val: string) => ({
  ...
  },
  {
    id: 'yearsToExit',
    emoji: '⏳',
    text: 'في كم سنة تتوقع خروجاً رئيسياً (استحواذ أو اكتتاب)؟',
    subtext: 'معظم الشركات الممولة من رأس المال المخاطر تستهدف خروجاً في 5–7 سنوات. كن واقعياً.',
    type: 'select',
    options: [
      { value: '3', label: '3 سنوات — جدول زمني طموح' },
      { value: '5', label: '5 سنوات — أفق رأس المال المخاطر النموذجي' },
      { value: '7', label: '7 سنوات — مسار أطول' },
      { value: '10', label: '10 سنوات — رأس مال صبور' },
    ],
    mapTo: 'yearsToExit',
    defaultValue: '5',
    transform: (val: string) => ({
  ...
  },
  {
    id: 'berkusMilestones',
    emoji: '✅',
    text: 'أي من هذه المعالم أنجزت شركتك؟',
    subtext: 'اختر كل ما ينطبق. يُستخدم هذا لطريقة بيركوس للتقييم — رائع للشركات في المراحل المبكرة.',
    type: 'multiselect',
    options: [
      { value: 'idea', label: '💡 لدينا فكرة مثبتة / ملاءمة واضحة بين المشكلة والحل' },
      { value: 'prototype', label: '🛠️ لدينا نموذج أولي أو منتج قابل للتطبيق (MVP)' },
      { value: 'team', label: '👥 لدينا فريق قوي وذو خبرة' },
      { value: 'relationships', label: '🤝 لدينا شراكات رئيسية أو خطابات نوايا أو اتفاقيات توزيع' },
      { value: 'revenue', label: '💳 لدينا عملاء يدفعون أو عقود موقعة' },
    ],
    mapTo: 'berkusMilestones',
    defaultValue: [],
    transform: (val: string[]) => ({
